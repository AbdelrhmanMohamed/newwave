...
export async function generateMetadata(
    ...
    console.log("Generating metadata for Career with slug:", slug);
...
export default async function CareerDetailsPage({
    ...
    if (!careerData) {
        return <div className="text-center py-20">No data found for this career.</div>;
    }
            ...
            <div className="grid lg:grid-cols-6 gap-10 px-6 items-start">
                ...
                <div className="lg:col-span-4">
                    ...
                    <div className="relative mb-12">
                        ...
                        <div className="mt-4 flex items-center text-sm justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <span>{new Date(careerData.date).toLocaleDateString() || "Unknown Date"}</span>
                            </div>
                            <div className="flex items-center space-x-2">
                    ...
                    <div className="space-y-10">
                        <div>
                            <h2 className="text-2xl font-bold mb-4">{careerData.title || "Unknown Title"}</h2>
                ...
                <div className="border border-primary space-y-5 px-4 py-6 lg:col-span-2">
                    <h2 className="text-4xl font-bold text-center py-4">Join Our Team
                    </h2>
                    <CareerForm careers={careers || []} isSide careerId={Number(careerData.id)} />
                </div>
            </div>
